...
class stats_newsletters_update_htmlopens extends Upgrade_API
{
	...
	*/
	function RunUpgrade()
	{
		...
		$query = 'update ' . SENDSTUDIO_TABLEPREFIX . 'stats_newsletters set htmlopens=0, htmlopens_unique=0, textopens=0, textopens_unique=0 WHERE htmlopens IS NULL AND htmlopens_unique IS NULL AND textopens IS NULL AND textopens_unique IS NULL';
