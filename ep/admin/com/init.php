...
/**
 * MAGIC: Autoload
 * Magic function for autoloading "library" class
 *
 * This function will autoload "library" classes located in the lib directrory (and it's sub-directory).
 *
...
function __iem_exception_handler(Exception $e)
{
	...
	// ----- Print out message for special cases
...
if (!function_exists('date_default_timezone_get')) {
	 ...
	 * This function is only available to PHP 5.2 or above
	 *
	 * NOTE: This function will NOT query the TZ environment variable nor the system settings.
	 * If nothing is found, it will simply return UTC
	 *
...
// Pre-check
// TODO should this be checked each time? -- Re-do how it defines disabled functions
// TODO check whether or not ini_get is available? if possible catch errors for it
