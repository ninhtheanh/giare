...
<script>
	$(function() {
		...
		$('#PreviewEmail_Message').load('index.php?Page=<?php print $IEM['CurrentPage']; ?>&Action=SendPreview', temp);
	});
</script>
...
<div id="PreviewEmail_Container">
	<div id="PreviewEmail_MessageContainer">
		<div id="PreviewEmail_Message">
			...
			<?php print GetLang('SendPreview_Loading'); ?>
		</div>
	</div>
	<?php print GetLang('Preview_CustomFieldsNotAltered'); ?>
</div>
