<?php $IEM = $tpl->Get('IEM'); ?><div id="Bounce_Step_Nav_Container">
	<ul style="margin-left:0px;">
		<li class="Bounce_Step_Nav_First">
			<span class="Bounce_Step_Nav_General_First">
				...
				<?php echo GetLang('Pick_Contact_List'); ?>
				</span>
			</span>
		</li>
		<li class="Bounce_Step_Nav">
			<span class="Bounce_Step_Nav_General">
				...
				<?php echo GetLang('Find_Mail_Server'); ?>
				</span>
			</span>
		</li>
		<li class="Bounce_Step_Nav">
		...
		<li class="Bounce_Step_Nav">
			<span class="Bounce_Step_Nav_General">
				...
				<?php echo GetLang('Remove_Contacts'); ?>
				</span>
			</span>
		</li>
		<li class="Bounce_Step_Nav">
