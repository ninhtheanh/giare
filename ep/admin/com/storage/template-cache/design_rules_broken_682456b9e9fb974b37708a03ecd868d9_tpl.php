...
<script>
	...
	$(function() {
		...
		$('div#printBroken').click(function() {
			if(ruleList > ruleLoaded) alert('<?php print GetLang('DesignRules_PrintNotFinishedLoading'); ?>');
			else window.print();
		});
...
<body>
	...
	<div id="printBroken"><a href="javascript:void(0);" title="Print list"></a></div>
		<?php print GetLang('DesignRules_Header'); ?>
		<?php print GetLang('DesignRules_Intro'); ?>
	</div>
	<div id="previewList"><?php if(isset($GLOBALS['BrokenRuleList'])) print $GLOBALS['BrokenRuleList']; ?></div>
</body>
</html>
