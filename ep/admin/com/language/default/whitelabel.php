...
/**
 * Anything in this file has a mention or link to http://www.anonym.to/?http://www.interspire.com.
...
defined('LNG_ApplicationTitle') or define('LNG_ApplicationTitle', 'Email Marketer');
...
define('LNG_SMTPCOM_Explain', '
	<a href="http://www.anonym.to/?http://interspire.smtp.com/" target="_blank" border="0"><img src="images/smtp_com_logo.gif" border="0" /></a>
	...
	<div>
		...
		<ol style="line-height:1.5">
			<li><a href="http://www.anonym.to/?http://interspire.smtp.com/" target="_blank">Sign up for an SMTP.com account here</a> (Customers receive a discount on the normal prices)</li>
...
define('LNG_Index_LatestNewsURL', 'http://www.anonym.to/?http://www.interspire.com/content/blogrss.php');
define('LNG_PopularHelpArticles', 'Popular Help Articles');
define('LNG_Index_PopularArticlesURL', 'http://www.anonym.to/?http://www.viewkb.com/rss.php?c=138&t=popular');
define('LNG_UpgradeNoticeInfo', '
	...
	<p style="text-align: left;"><a target="_blank" href="http://www.anonym.to/?http://www.interspire.com/emailmarketer/"><img border="0" alt="" src="images/learnMore.gif"/></a></p>
');
...
define('LNG_UpgradeMeLK', ' (<a href="http://www.anonym.to/?http://www.interspire.com/emailmarketer/" target="_blank">Upgrade</a>)');
define('LNG_ApplicationTitleEdition', ' (%s Edition)');
define('LNG_SendingSystem', LNG_ApplicationTitle);
define('LNG_UrlPF_Intro', 'You\'re currently running a free trial of '.LNG_ApplicationTitle.'.%sYou\'re on day %s of your %s day free trial. <a href="http://www.anonym.to/?http://www.interspire.com/emailmarketer/pricing.php" target="_blank">Click here to learn about upgrading</a>.');
define('LNG_UrlPF_ExtraIntro', ' During the trial, you can send up to %s emails. ');
define('LNG_UrlPF_Intro_Done', 'You\'re currently running a free trial of '.LNG_ApplicationTitle.'.%sYour license key expired %s days ago. <a href="http://www.anonym.to/?http://www.interspire.com/emailmarketer/pricing.php" target="_blank">Click here to learn about upgrading</a>.');
define('LNG_UrlP', '');
...
define('LNG_Form_Branding', '<span style="display: block; font-size: 10px; color: gray; padding-top: 5px;">Email marketing</span>');
...
define('LNG_Home_Video_Link','http://www.anonym.to/?http://static.interspire.com/iem-quick-tour/index.html');
define('LNG_Home_Getting_Starting_Link','http://www.anonym.to/?http://www.interspire.com/emailmarketer/pdf/InterspireEmailMarketerUserGuide.pdf');
 ...
 **************************
 */
define('APPLICATION_SHOW_WHITELABEL_MENU', false);
