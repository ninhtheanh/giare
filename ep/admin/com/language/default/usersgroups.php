...
define('LNG_UsersGroups_Field_Access_MailingLists', 'Contact Lists');
define('LNG_HLP_UsersGroups_Field_Access_MailingLists', 'Which contact lists will this client have access to? The permissions selected above will be applied to these lists.');
...
define('LNG_UsersGroups_Restrictions_MailingLists_Unlimited', 'Unlimited contact lists');
define('LNG_UsersGroups_Restrictions_MailingLists_Finite', 'Maximum Number of Contact Lists');
define('LNG_HLP_UsersGroups_Restrictions_MailingLists_Finite', 'The number of contact lists that this user can create.');
