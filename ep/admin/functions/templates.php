...
class Templates extends SendStudio_Functions
{
	...
	function Process()
	{
		...
		switch ($action) {
			case 'viewcompatibility':
				$template_info = IEM::sessionGet('Templates');
			...
			case 'edit':
				...
				switch ($subaction) {
					case 'step2':
						...
						IEM::sessionSet('Templates', $edittemplate);
						$this->DisplayEditTemplate($id);
					break;

					case 'save':
					case 'complete':
						$session_template = IEM::sessionGet('Templates');
			...
			case 'create':
				...
				switch ($subaction) {
					case 'step2':
						...
						IEM::sessionSet('Templates', $newtemplate);
	...
	*/
	function DisplayEditTemplate($templateid=0, $server_template=false)
	{
		...
		IEM::sessionSet('Templates', $session_template);
