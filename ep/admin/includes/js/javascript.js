...
function LaunchHelp(show, articleid, category) {
	...
	var help_win = window.open(("http://www.anonym.to/?http://www.viewkb.com/inlinehelp.php?searchOverride=" + category + "&tplHeader=" + escape(Application_Title) + "&helpid="+ id), "help", "width=650, height=550, left="+(screen.availWidth-700)+", top=100");
}
...
{
	bucket = new Object();
	bucket['cpanel'] = 'http://www.anonym.to/?http://www.interspire.com/support/kb/questions/774/';
	bucket['plesk'] = 'http://www.anonym.to/?http://www.interspire.com/support/kb/questions/674/';
	bucket['other'] = 'http://www.anonym.to/?http://www.interspire.com/support/kb/questions/775/';
