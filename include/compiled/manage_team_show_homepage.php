              ...
              <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                ...
                <tr <?php echo $index%2?'':'class="alt"'; ?> id="team-list-id-<?php echo $one['id']; ?>">
                  ...
                  <td nowrap align="center">				  
					<input type="checkbox" name="show_homepage_<?php echo $one['id']; ?>" <?php echo $one['show_homepage'] == 1 ? 'checked="checked"' : ''; ?>/>
                  </td>
                  <td class="op"><a href="/ajax/manage.php?action=teamdetail&id=<?php echo $one['id']; ?>" class="ajaxlink">Detail</a>｜<a href="/backend/team/edit.php?id=<?php echo $one['id']; ?>">Edit</a></td>
                </tr>
                <?php }}?>
