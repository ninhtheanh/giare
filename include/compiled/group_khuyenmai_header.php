<?php include template("group/khuyenmai_html_header");?>

<div id="hdw">
  <div id="hd">  	
    <div id="logo" align="left"><a href="/<?php echo $city['slug']; ?>/" class="link"><img src="/static/css/images/logo.jpg" alt="logo <?php echo $INI['system']['sitename']; ?>: cùng mua chung theo nhóm mua hot deal khuyen mai" /></a></div>
    <div class="guides">
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td rowspan="3" align="left" valign="top" nowrap="nowrap"><?php if($login_user['avatar']!=""){?>
                ...
                <?php } else { ?>
                <div style="margin-right:10px; border:1px #ccc solid;background:#fff;padding:2px; width:28px;height:28px"><img src="/static/css/images/noavatar.jpg" width="28" height="28"  alt="user <?php echo $INI['system']['sitename']; ?>: cùng mua chung theo nhóm mua hot deal khuyen mai" /></div>
                <?php }?>
                <?php }?></td>
