...
<div id="coupons">
	<div class="subdashboard" id="dashboard">
		<ul><?php echo mcurrent_order('datratien'); ?></ul>
	</div>
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            <div class="subbox-top"><div class="subhead">
                    <h2>Đơn hàng đã trả tiền trước hoặc đã chuyển khoản</h2>
				</div></div>
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="filter-table">
              ...
              <tr><td colspan="10" style="padding-bottom:10px"><input type="submit" value=" Lọc dữ liệu " class="formbutton"  style="padding:3px 6px;"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Total: <?php echo $count; ?> ĐH</strong></td></tr><form>
                ...
                <div class="sect">
					...
					<tr><th width="20">ID</th><th width="300">deal</th><th width="300">user</th><th width="20" nowrap>q.ty</th><th width="60" nowrap>total (<span class="money"><?php echo $currency; ?></span>)</th><!--<th width="60" nowrap>UnPaid (<span class="money"><?php echo $currency; ?></span>)</th>--><th width="60" nowrap>datratien (<span class="money"><?php echo $currency; ?></span>)</th><!--<th width="50" nowrap>express</th>--><th width="50" nowrap>operation</th></tr>
					...
					<tr style="background-color:#<?php echo getStatusColor($one['state']); ?>" id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td align="right"><?php if($one['state']=='datratien' && $order['money']==0 && $order['credit']==0){?><?php echo print_price(moneyit($one['origin'])); ?> <?php } else { ?><?php echo print_price(moneyit($one['money'])); ?><?php }?></td>
						<!--<td><?php echo $option_delivery[$teams[$one['team_id']]['delivery']]; ?><?php echo $one['express_id']?'Y':''; ?><?php echo $option_service[$one['service']]; ?></td>-->
						<td class="op" nowrap> <!--<a href="/ajax/manage.php?action=orderedit&id=<?php echo $one['id']; ?>" class="ajaxlink">edit</a> |--> <a href="/ajax/manage.php?action=orderview&id=<?php echo $one['id']; ?>" class="ajaxlink">Chi tiết</a>
						<br /><a href="/ajax/manage.php?action=orderpay&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="sure to cancel it?"><strong>Thành công</strong></a></td>
					</tr>
					<?php }}?>
