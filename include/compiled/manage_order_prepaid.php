...
<div id="coupons">
	<div class="subdashboard" id="dashboard">
		<ul><?php echo mcurrent_order('prepaid'); ?></ul>
	</div>
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            <div class="subbox-top"><div class="subhead">
                    <h2>Đơn hàng trả tiền trước (chờ xác nhận thanh toán)</h2>
				</div></div>
            <div class="box-content">
                	<form method="get">
                    	<table width="100%" border="0" cellspacing="2" cellpadding="0" class="filter-table">
                          ...
                          <tr>
                            ...
                            <td align="right" nowrap="nowrap" style="padding-left:3px;"><strong>Mobile:</strong></td><td><input type="text" class="h-input" name="mobile" value="<?php echo $mobile; ?>" /></td><td style="padding-left:10px;" colspan="4">
                ...
                <div class="sect">
					...
					<tr><th width="20">ID</th><th width="400">deal</th><th width="260">user</th><th width="20" nowrap>Q.ty</th><th width="60" nowrap>total (<span class="money"><?php echo $currency; ?></span>)</th><!--<th width="160" nowrap>express</th>--><th width="130" nowrap>operation</th></tr>
					...
					<tr  style="background-color:#<?php echo getStatusColor($one['state']); ?>" id="order-list-id-<?php echo $one['id']; ?>">
                        ...
                        <br /><span style="color:#c40000"><strong><?php echo GetShippingName($one['shipping_id']); ?> - <?php echo GetPaymentName($one['payment_id']); ?></strong></span></td>
