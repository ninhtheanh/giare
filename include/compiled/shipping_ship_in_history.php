...
<div id="coupons">
	<div class="subdashboard" id="dashboard">
		<ul><?php echo mcurrent_shipping('ship_in_history'); ?></ul>
	</div>
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            <div class="subbox-top"> <div class="subhead">
                    <h2>Lịch sử nộp tiền</h2>
				</div></div>
            <div class="box-content">
				<div class="sect" style="padding:5px; background:#AADFF1">
					<form method="get">
                        Mã nộp tiền <input type="text" name="in_id" value="<?php echo $in_id; ?>" class="h-input"/>&nbsp;&nbsp;Người xử lý <select name="user" id="user" class="h-input" require="true"><option value='0'>--Chon--</option><?php echo Utility::Option(Utility::OptionArray($alladmins,'username','username'),$user); ?></select>&nbsp;&nbsp;Ngày xử lý <input type="text" class="h-input" onFocus="WdatePicker({isShowClear:false,readOnly:true})" name="cbday" value="<?php echo $cbday; ?>" /> - 
                ...
                <form method="post" action="">    
                    ...
                    <?php 
                        switch($one['act']){
                            ...
                            case 'XACNH' : $act = 'Xác nhận'; break;  
                            case 'HUYXA' : $act = 'Hủy xác nhận'; break;                        
                        }
                    ; ?>
                    <?php                             
                            $condition['in_id'] = $one['in_id'];
                        ...
                        <td style="<?php echo $bgcolor; ?>"><?php if($one['head']==1){?><h3><?php echo $one['in_id']; ?></h3><?php }?></td>
