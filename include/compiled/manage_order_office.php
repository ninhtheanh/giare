      ...
      <div id="content" class="coupons-box clear mainwide">
        <div class="box clear">
          <div class="subbox-top"><div class="subhead">
              ...
              <ul class="filter"><?php echo current_manageorder_confirm('office', 0); ?></ul>
            </div></div>
              ...
              <form id="fde" name="f_delivery" method="post" action="./office.php" onsubmit="return checkForm()" target="_blank">
                ...
                <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                  <tr>
                   ...
                   <th width="60" nowrap>Unpaid (<span class="money"><?php echo $currency; ?></span>)</th>
                  ...
                  <tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
                    ...
                    <td><!--<a href="/ajax/manage.php?action=userview&id=<?php echo $one['user_id']; ?>" class="ajaxlink">--><a href="/backend/order/search.php?mobile=<?php echo $one['mobile']; ?>&city_id=11" target="_blank" ><?php echo $one['realname']; ?></a><br />
                    ...
                    <td class="op"><!-- <a href="/ajax/manage.php?action=orderedit&id=<?php echo $one['id']; ?>" class="ajaxlink">Edit</a> |--> <a href="/ajax/manage.php?action=orderedit&id=<?php echo $one['id']; ?>" class="ajaxlink">edit</a> | <a href="/ajax/manage.php?action=orderview&id=<?php echo $one['id']; ?>" class="ajaxlink">Detail</a> | <a href="/ajax/manage.php?action=orderconfirm&id=<?php echo $one['id']; ?>" class="ajaxlink">Confirm</a> | <a href="/ajax/manage.php?action=ordercancel&id=<?php echo $one['id']; ?>" class="ajaxlink">Cancel</a> | <a href="/ajax/manage.php?action=orderhanging&id=<?php echo $one['id']; ?>" class="ajaxlink">Tạm hoãn</a></td>
                  </tr>
                  <?php }}?>
                  <tr>
