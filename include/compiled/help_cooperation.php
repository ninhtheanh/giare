...
<div id="bdw" class="bdw">
  <div id="bd" class="cf">
    <div id="learn">
        ...
        <ul>
          <?php echo current_help('hop-tac-kinh-doanh'); ?>
        </ul>
      </div>
                  ...
                  <td align="left" valign="top" width="80%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#f1f1f1" style="padding-top:5px;"><div align="left" style="font-size:17px;"><h2>Hợp tác kinh doanh</h2></div>
                            <div> <?php echo htmlspecialchars_decode($page['value']); ?></div></td>
