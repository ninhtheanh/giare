...
<head>
    ...
    <title> Deal Soc | Giá Rẻ | Nhóm mua chung hotdeal, cùng mua deal khuyến mãi deal gía rẻ, mua hàng theo nhóm dealsoc </title>
    <?php } else if($team) { ?>
    <title><?php echo $team['short_title']; ?> <?php echo ($seo_title) ? ' '.$seo_title : '';; ?> | <?php echo ($_GET['comment']) ? 'thảo luận deal - ' : '';; ?><?php echo $INI['system']['sitename']; ?> | phiếu khuyến mãi giảm giá cực rẻ</title>    
     <?php } else if(strpos($_SERVER['REQUEST_URI'],'/team/')!==false) { ?>
  	...
  	<?php }?>
    <?php if(!$pagetitle||$request_uri=='index'){?>
    	 <meta name="description" content="Deal soc Mua hàng theo nhóm giá rẻ hot deals Cùng nhóm mua chung sản phẩm giá rẻ, dịch vụ giá rẻ, mua sắm giá rẻ,du lịch giá rẻ, làm đẹp giá rẻ, ăn uống giá rẻ, nhà hàng giá rẻ,  thời trang giá rẻ, spa giá rẻ và các sản phẩm khuyến mãi giá rẻ độc đáo tại Dealsoc.vn - trang <?php echo ($_GET['page']) ? $_GET['page'] : 1;; ?>" />
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=9" />
      <?php if(!$pagetitle||$request_uri=='index'){?>
     	<meta name="keywords" content="gia re, giare,dealsoc,deal soc, deal, deals, nhommua, hotdeal, hotdeals, cungmua, muachung, nhom mua, cung mua,mua chung,mua theo nhom, mua hang theo nhom, giam gia, uu dai, coupon, khuyen mai, deal hôm nay, <?php echo $city['name']; ?>" />
