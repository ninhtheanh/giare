              ...
              <table class="adminlist" cellpadding="0" cellspacing="0">
                <form name="frmshippingrate" method="POST">
                  ...
                  <tr>
                    ...
                    <th align="left" nowrap="nowrap" width="20%">Khu vực</th>
                    <th align="left" width="10%" nowrap="nowrap">Điều kiện</th>
                    <th align="left" width="5%" nowrap="nowrap">Tổng giá trị đơn hàng</th>
                    <th>&nbsp;</th>
                  </tr>
                  ...
                  <tr <?php echo $bgcolor; ?>>
                    ...
                    <td align="left" ><input type="text" name="shippingrate[<?php echo $one['rate_id']; ?>][rate_value]" value="<?php echo $one['rate_value']; ?>" onChange="DoubleCheck(<?php echo $one['rate_id']; ?>)"class="f-input" require="true" datatype="require" size="10" onkeypress="return check_num(this,10,event)">
                    ...
                    <td align="left" ><select name="shippingrate[<?php echo $one['rate_id']; ?>][destination]" id="shippingrate[<?php echo $one['rate_id']; ?>][destination]" onChange="DoubleCheck(<?php echo $one['rate_id']; ?>)" class="f-input" require="true" datatype="require">
                        
              <?php echo LoadDestination($one['destination_id']);; ?>
            <option value="ss">aaaaaaaaaa</option>
                      </select>
                    </td>
                    <td align="left"><select name="shippingrate[<?php echo $one['rate_id']; ?>][condition_value]" id="sr<?php echo $shipping_id; ?>" onChange="DoubleCheck(<?php echo $one['rate_id']; ?>)" disabled class="f-input" require="true" datatype="require">
                      ...
                      <script>
					$("#sr<?php echo $shipping_id; ?>").val("<?php echo $condition_value; ?>");
				</script></td>
                    <td align="left" ><input type="text" name="shippingrate[<?php echo $one['rate_id']; ?>][subtotal]" value="<?php echo $one['subtotal']; ?>" onChange="DoubleCheck(<?php echo $one['rate_id']; ?>)" class="f-input" require="true" datatype="require"></td>
                    <td>&nbsp;</td>
                  </tr>
                  <?php }}?>
                  <tr>
                  ...
                  <tr>
                    <td></td>
                    <td colspan="8" align="left"><input type="submit" value="Cập nhật" name="update" class="formbutton" >&nbsp;<input type="button" value="Xóa" name="dodelect" onClick="GoDelete()" class="formbutton" >&nbsp;<input type="button" value="Quay lại" name="dodelect" onClick="window.location.href='/backend/logistics/transport.php'" class="formbutton" >
                    </td>
                  </tr>
                </form>
                <form name="frmnew" method="POST">
                  ...
                  <tr valign="bottom" >
                    ...
                    <td align="left"><input size="10" name="shippingrate[rate_value]" type="text" class="f-input" require="true" datatype="require" id="shippingrate[rate_value]" onkeypress="return check_num(this,10,event)">
                      <select name="shippingrate[rate_type]" class="f-input" require="true" datatype="require">
                        <option value="Money">vnd</option>
                        <option value="Percent">%</option>
                      </select>
                    </td>
                    <td align="left" ><select name="shippingrate[destination]" id="shippingrate[destination]" onChange="DoubleCheck(<?php echo $one['rate_id']; ?>)" class="f-input" require="true" datatype="require">
              ...
              <?php echo $destination_list; ?>
                    ...
                    <td align="left" ><input type="text" name="shippingrate[subtotal]" id="shippingrate[subtotal]" class="f-input" require="true" datatype="require" onkeypress="return check_num(this,10,event)"></td>
