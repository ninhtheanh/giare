...
<div id="atbreadcrum">
  <div class="atbreadcrum" style="margin-left: 260px;margin-top: -22px; color:#64a64e;" >
    <a href="/"
      <?php  echo $city['slug']; ?>">Khuyến mãi
    </a>
    <?php  if(isset($arrcatid[$gid])): ?>
    > <a href=""
      <?php  echo $arrcatid[$gid][0]; ?>">
      ...
      <td valign="top">
        <div class="detail_info_content_top">
          ...
          <div id="atdetail_info">
            <div class="atinfo_productat">
              <span class="atinfopatt">
                <?php if($team['delivery_properties']==1 || ($city['id']==556 && $team['group_id']!=23)){?>
                <strong>Giao sản phẩm</strong>
                <img src="/static/img/icon_product.png" align="absmiddle" alt="Giao sản phẩm" />
                <?php } else { ?>
                <strong>Giao Voucher </strong>
                <img src="/static/img/icon_voucher.png" align="absmiddle" alt="Giao voucher" />
                <?php }?>
              </span>
              <span class="atinfonumview">
                <strong>Số người xem: </strong>
                <?php  echo $team['viewed']; ?>
              </span>
            </div>
            <div class="atdetail_title">
              <h1>
                <?php echo $team['masp']; ?>: <?php echo $team['product']; ?>
              </h1>
            </div>
            <div class="deal_summary" style="height: 120px;overflow: hidden;line-height: 2;">
              <?php echo $team['title']; ?>
            </div>
            <div class="box_color_price" style="clear: both;float: left;width: 91%;padding: 3px 14px;margin-bottom: 7px;">
              ...
              <div class="color" style="margin: 10px 0px;" id="checkboxes_color">
                ...
                <?php 	
				 ...
				 ?>
                <a id="color_"
                  <?php  echo $team['id']; ?>" class="setcolor <?php  echo $clsactive; ?>" onclick="setColorTeam(<?php  echo $team['id']; ?>,'<?php  echo $color ?>');"><span style="cursor:pointer;border:1px solid #999;width:16px; height:16px; display:inline-block;background:"
                    <?php  echo $color; ?>">
                  </span>
                </a>
                <?php  
              ...
              <div class="price_btn_order">
                <div class="box_detail_price">
                  <?php
                   ...
                   ?>
                  <div class="detail_team_price">
                    <?php echo print_price(moneyit($price_after_promotion)); ?>
                    <sub>VNĐ</sub>
                  </div>
                  <div class="detail_market_price">
                    <?php echo print_price(moneyit($team[market_price])); ?> đ
                  </div>
                </div>
                <div class="box_btn_order">
                  ...
                  <span>
                    ...
                    <a href="/team/ataddcart.php?id="
                      <?php  echo $team['id']; ?>" style="font-size: 16px;color: #FFFFFF;display: block;padding-left: 6px;width: 135px;margin: 0px auto;height: 45px;" class="ataddcart boxbuttoncss">
            ...
            <div class="box_detail_sale_buycount" style="font-weight: bold;">
              <div class="detail_infoleft">
                <span class="detail_discountper">
                  <?php echo ceil(moneyit((100*($team['market_price'] - $team['team_price'])/$team['market_price']))); ?>%
                </span>
                <span class="detail_info_discounttext">Tiết kiệm</span>
              </div>
              <!--Micro-->
              <div itemscope="" itemtype="http://schema.org/Product" style="display:none;">
                <img itemprop="image" src=""<?php echo $INI['system']['wwwprefix']; ?>/static/<?php echo $team['image']; ?>" /> <span itemprop="name">
                  <?php echo $team['short_title']; ?>
                </span> <span itemprop="description">
                  <?php echo cut_string(strip_tags($team['title']),150,""); ?> [xem thêm]
                </span>
                <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                  <span itemprop="price">
                    <?php echo print_price(moneyit($team[team_price])); ?>
                  </span>
              ...
              <div class="detail_info_right">
                <div class="detail_info_buy">
                  <span>
                    <?php echo $team['now_number']+$team['pre_number']; ?>
                  </span>
                  <span>Người mua</span>
                </div>
        ...
        <div class="detail_box_info_coment">
          <div class="tabbed_area">
            <ul class="tabs">
              <li>
                <a title="Thông tin" class="tab active" id="lithongtin" art="content_1">Thông tin</a>
              </li>
              <li>
                <a title="Thảo luận" class="tab" id="lithaoluan" art="content_2">Thảo luận</a>
              </li>
            </ul>
            <div class="atboxinfocoment">
              <div id="content_1" class="tabcontent">
                <div id="team_desc">
                  <?php echo htmlspecialchars_decode($team['detail']); ?>
                </div>
                <!-- share social -->
                </br>
                <div class="box_sharesocial">
                  <a href="http://digg.com/submit?phase=2&url=http://www.cheapdeal.vn/"
                    <?php echo seo_url($team['short_title'],$team['id'],$url_suffix); ?>&title=<?php echo $team['short_title']; ?> ®&bodytext=<?php echo cut_string(strip_tags($team['title']),150,""); ?> [xem thêm]&topic=world_news" target="_blank"> <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAC8AAAAbCAMAAADbEiYlAAAABlBMVEX///8LCwpatgxKAAAAaklEQVQ4EeWTSwrAIAwF4/0vXZq8FEckxU1raRbKSwY0P7OwdpqZLjmLa1O++DFDa4k63dVHui9CIpOQyppEFDnVI/zVWH+tVPdEDkmQv+Q96W/OA9eASr2Uk4pkKBJU4D2kY9wGgBLv8QfIQgLkrFnG6wAAAABJRU5ErkJggg==" width="35px" height="20px"/ >
                  </a>
              ...
              <div id="content_2" class="tabcontent" style="display:none;">
                <table width="100%" border="0">
                  <tr>
                    <td width="1%" align="left" valign="top" style="padding-left:20px;">
                    ...
                    <td width="20%" align="left" valign="top" style="padding-left:15px;">
                      <a href="/"
                        <?php echo seo_url($team['short_title'],$team['id'],$url_suffix); ?>?comment=display#div_dealcomment">
                        <img src="/static/css/images/comment.gif" height="41" width="134" alt="Thảo luận hotdeal giá rẻ" border="0" />
                      </a>
                    </td>
                    <td width="60%" align="left" valign="top" style="padding-left:10px;">
                      <div align="left" style="white-space:nowrap">
                        <strong style="font-size:100%">Mời bạn đóng góp cảm nhận cho sản phẩm này</strong>
                      </div>
                      <div align="left" style="padding-left:5px; overflow:hidden;">
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top" nowrap="nowrap">
                              <div align="left" style="width:175px; height:27px; overflow:hidden; white-space:nowrap">
                                <a href=""
                                  <?php echo share_facebook($team); ?>"><img src="/static/css/images/facebook.gif" width="27" height="27" border="0" />
                                </a>&nbsp;&nbsp;<a href=""
                                  <?php echo share_twitter($team); ?>"><img src="/static/css/images/twitter.gif" width="27" height="27" border="0" />
                                </a>&nbsp;&nbsp;<a href=""
                                  <?php echo share_mail($team); ?>"><img src="/static/css/images/mail.gif" width="27" height="27" border="0" />
                                </a>&nbsp;&nbsp;
                                <script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script>
                                <g:plusone></g:plusone>
                              </div>
                            </td>
                            <td align="left" valign="top" style="padding-top:5px; padding-left:5px;" width="46">
                              <div id="fb-root"></div>
                              <fb:like href="http://www.cheapdeal.vn/"
                                <?php echo seo_url($team['short_title'],$team['id'],$url_suffix); ?>" send="false" layout="button_count" width="46" show_faces="true" share="true" action="like" font="arial">
                              </fb:like>
                            </td>
                          </tr>
                        </table>
        ...
        <div class="boxpricebuttnmid">
          <div class="detailmidbox" style="text-align:center;padding-top: 9px;">
            <span>
              <?php  if($team['begin_time']<time() && $team['end_time'] > time()): ?>
              <a href="/team/ataddcart.php?id="
                <?php  echo $team['id']; ?>" style="font-size: 16px;color: #FFFFFF;display: block;padding-left: 6px;width: 208px;margin: 0px auto;height: 50px;" class="ataddcart boxbuttoncss">
          ...
          <table width="100%" class="detail_map_deal">
            <tr>
              <td class="atmap" valign="top">
                <div class="detail_add_title">Bản đồ</div>
...
if(!$partner['longlat'])
 ...
 ?>
                  ...
                  <!--{/if}-->
                  <?php  	/*  <div align="center"><img src="/static/<?php echo $partner['image1']; ?>" alt="<?php echo $partner['title']; ?>" />
                </div>  */ ?>
              </div>
      </td>
      <td valign="top">
...
<td width="244" valign="top">
  ...
  <ul class="atmore_dealright">
    ...
    <?php 
                    ...
                    ; ?>
    <li
      <?php echo $class; ?>> <a href="/"
        <?php echo seo_url($one['short_title'],$one['id'],$url_suffix); ?>" class=""> <img src=""<?php echo team_image($one['image'],true,240); ?>" alt="" title="" width="219" height="316" class="img_more_right" />
      </a> <a href="/"
        <?php echo seo_url($one['short_title'],$one['id'],$url_suffix); ?>" class="linktitlemoreright"><?php echo $one['short_title']; ?>
      </a>
      <div class="box_right_price_sale">
        <span class="pricetoge">
          <?php echo print_price(moneyit($one['team_price'])); ?>đ
        </span>
        <span class="right_marketprice">
          <?php echo print_price(moneyit($one['market_price'])); ?>đ
        </span>
        <span class="right_sale">
          Giảm <?php echo ceil(moneyit((100*($one['market_price'] - $one['team_price'])/$one['market_price']))); ?>%
        </span>
      </div>
    </li>
    <?php }}?>
...
<div style="display:none;" typeof="v:Review-aggregate" xmlns:v="http://rdf.data-vocabulary.org/#">
  <span property="v:itemreviewed">
    <?php echo $team['short_title']; ?> - C<?php echo $team['id']; ?>
  </span> <span rel="v:rating">
    <span typeof="v:Rating">
      <span property="v:average">
        <?php echo ceil(moneyit((10*($team['team_price'])/$team['market_price']))); ?>
      </span> su <span property="v:best">10</span>
    </span>
  </span>CheapDeal<span property="v:count">
    <?php  echo $team['viewed']; ?>
  </span> student
</div>
<div style="display:none;" itemprop="offers" itemscope="" itemtype="http://schema.org/AggregateOffer">
  <span itemprop="lowPrice">
    <?php echo print_price(moneyit($team[team_price])); ?>
  </span> to <span itemprop="highPrice">
    <?php echo print_price(moneyit($team[market_price])); ?>
  </span> from <span itemprop="offerCount">
    <?php echo ceil(moneyit((100*($team['market_price'] - $team['team_price'])/$team['market_price']))); ?>%
  </span>
</div>
...
<div style="display:none;" itemscope="" itemtype="http://schema.org/CivicStructure">
  <span itemprop="name">Giờ mở cửa</span>
...
<div  style="display:none;" itemscope="" itemtype="http://schema.org/LocalBusiness">
  <h1>
    <span itemprop="name">Cheapdeal.vn HCM</span>
  </h1>
  <span itemprop="description">
    <?php echo $partner['address']; ?>
  </span>
  <div  style="display:none;" itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
    <span itemprop="streetAddress">137/5A Le Van Sy, P. 13, Q. PN</span> <span itemprop="addressLocality">Ho Chi Minh City</span>, <span itemprop="addressRegion">Vietnam</span>
  </div>
  Phone: <span itemprop="telephone">083-991-4018</span>
</div>
<!--Feedback-->
<script type="text/javascript">
  var _urq = _urq || [];
