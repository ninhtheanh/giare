...
<div id="content" class="mainwide">
    <div id="deal-buy" class="box">
        <div class="subbox-content" style="min-height:470px;_height:470px"><div style="background-color:#FFFFFF; min-height:470px;_height:470px"><div align="left" style="padding:20px;padding-top:10px; padding-bottom:10px;"><div align="left" style="font-size:20px; padding-bottom:10px;">
          <h2>Thông tin Thanh toán va Vận chuyển</h2>
        </div>
