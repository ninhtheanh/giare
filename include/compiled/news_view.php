	...
	<tr>
    	<td valign="top">
              <table width="100%">
              	<tr>
                	<td>
                    	<a style="font-weight:bold" href="/tin-tuc/<?php echo seo_url($hotNews['title'],$hotNews['id'], $url_suffix, '_'); ?>" class="home_title"><?=$hotNews['title']?></a>
                        <p align="justify">
                            <?
                                if($hotNews['image'] != "")
                                {
                ...
                <tr>
                	<td>
                    	<table width="100%" border="0" cellspacing="0" cellpadding="10">                          
                          ...
                          ?>
                          <tr>
                            <td valign="top" class="text_subject">
                                <a style="font-weight:bold" href="/tin-tuc/<?php echo seo_url($title,$new_id, $url_suffix, '_'); ?>" class="home_title"><?=$title?></a>
                                <p align="justify">
                                    <?
                                        if($image != "")
                                        {
                                    ?>
                                        <a href="/tin-tuc/<?php echo seo_url($title,$new_id, $url_suffix, '_'); ?>"><img src="<?=$thumb?>" border="0" align="left" style="margin:0  15px 5px 0"></a>
                                    <?		
                                        }
                                    ?>
                                    <?=$subject?>
