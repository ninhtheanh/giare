<?php include template("group/hotdeal_header");?>
    ...
    <div id="recent-deals">
      <div id="content" class="mainwide">
        <div class="box clear">
          ...
          </tr><tr><td align="left" valign="top" style="padding-top:10px; padding-left:10px; padding-right:10px"><h1><strong>Thế nào đươc gọi là deal hot? </strong> </h1>
Mỗi ngày Dealsoc sẽ giới thiệu đến với người tiêu dùng nhiều sản phẩm, dịch vụ mới hay còn gọi là deal. Hot deals được định nghĩa là deal được nhiều người mua có khi lên đến vài ngàn người tham gia. Hot deal là một deal không chỉ được xem là deal có giá thành cực thấp mà còn được đánh giá là deal có giá trị hữu dụng, tiện ích và chất lượng. Các bạn đừng bỏ qua cơ hội được mua những hotdeal bằng cách mỗi ngày ghé thăm trang dealsoc.vn các bạn sẽ được khuyến mãi ưu đãi giá hot deal tour du lịch, hot deals nhà hàng, hot deal thời trang, hotdeal mỹ phẩm, hotdeal nha khoa ..... có khi được giảm giá tới 90%.</td></tr>
                <tr>
