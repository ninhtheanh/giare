<?php include template("group/cungmua_header");?>
    ...
    <div id="recent-deals">
      <div id="content" class="mainwide">
        <div class="box clear">
          ...
          </tr><tr><td align="left" valign="top" style="padding-top:10px; padding-left:10px; padding-right:10px">
<h1><Strong>Cùng mua chung vì lợi ích thiết thực cho bạn!</Strong></h1>
Việc cùng mua chung các deal sản phẩm, cung mua dịch vụ hay cung mua du lịch khuyến mãi giá rẻ, giúp cho chúng ta tiết kiệm được rất nhiều chi phí. Dealsoc.vn với thế mạnh cung cấp các sản phẩm độc đáo với giá tốt nhất để các bạn tha hồ lựa chọn. Ngoài ra các deal dịch vụ như spa, mỹ phẩm, ăn uống, nhà hàng, quán cafe, và deal, voucher du lịch cũng rất hấp dẫn và là sự lựa chọn hàng đầu để cùng mua chung của người dùng. Để được giá tốt nhất và các sản phẩm, dịch vụ và du lịch thiết thực, hãy vào Dealsoc.vn mỗi ngày để cùng mua chung những hot deal giá cực rẻ bạn nhé!</td></tr>
                <tr>
