...
<div id="maillist">
	<div class="subdashboard" id="dashboard">
		<ul><li class="current"><a href="#">&nbsp;&nbsp;Yahoo Connect </a><span></span></li></ul>
	</div>
    <div class="box clear">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td bgcolor="#f1f1f1"><form id="enter-address-form" action="/account/signupyahoo.php" method="post" class="validator">
              	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      <td align="left" height="35"><div class="field email">
							<label>Email: </label>
							<input id="enter-address-mail" name="email" class="f-input" type="text" value="<?php echo $_SESSION['YAHOO_USER_LOGIN']['email']; ?>" size="30" require="true" datatype="email" />
                    ...
                    <tr>
                      <td align="left" height="35"><div class="field">
                        <label>Họ tên</label>
                        <input type="text" size="30" name="realname" id="settings-realname" class="f-input" require="true" datatype="require" value="<?php echo $_SESSION['YAHOO_USER_LOGIN']['realname']; ?>" >                     
                        </div></td>
                    </tr>
                    <tr align="left">
                      <td style="background: url(&quot;/static/css/images/faqbox_break.gif&quot;) repeat-x scroll 0% 0% transparent;" height="4"></td>
                    ...
                    <tr>
                      <td align="left" height="35"><div class="field password">
							...
							<select id="gender" name="gender" class="f-input" require="true" datatype="require"><option value="">---Chọn---</option><?php echo Utility::Option($option_gender, ''); ?></select><script type="text/javascript">$("#gender").val("<?php echo $_SESSION['YAHOO_USER_LOGIN']['gender']; ?>")</script>
                        </div></td>
                    </tr>
                    <tr align="right">
                      <td style="background: url(&quot;/static/css/images/faqbox_break.gif&quot;) repeat-x scroll 0% 0% transparent;" height="4"></td>
                    ...
                    <tr>
                      <td align="left" height="35" style="padding-left:40px;"><div class="city">
							<label>&nbsp;</label>
							<input id="enter-address-commit" type="submit" class="formbutton" name="registeryahoo" value="Submit" />
						</div></td>
                    </tr>
                  </tbody>
                </table></form>
