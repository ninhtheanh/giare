				...
				?>
						...
						<script type="text/javascript">
                              function initialize() { 
								...
								var myLatlng = new google.maps.LatLng(10.795080, 106.651658);
								var map = new google.maps.Map(mapDiv, {
                                 ...
                                 var marker = new google.maps.Marker({
                                        position: myLatlng,
                                        title: '120/58 Trường Chinh, P12. Quận Tân Bình,TPHCM'
                                    });
                                    marker.setMap(map);
						...
						<div><?php echo htmlspecialchars_decode($page['value']); ?></div>
                <?php	
					}
				?>                  
                </div>
