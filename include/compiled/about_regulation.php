...
<div id="about">
	<div class="subdashboard" id="dashboard">
		<ul><?php echo current_help('quy-che'); ?></ul>
	</div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td bgcolor="#f1f1f1"><div align="left" style="padding-bottom:15px;font-size:17px;"><h3>QUY CHẾ SÀN GIAO DỊCH THƯƠNG MẠI ĐIỆN TỬ DEALSOC</h3></div><div align="left"><?php echo $page['value']; ?></div></td>
