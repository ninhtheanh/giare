    ...
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            <div class="subbox-top"><div class="subhead">
                    ...
                    <ul class="filter"><?php echo current_manageorder('calling_times_2', 0); ?></ul>
				</div></div>
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td align="center"><a href="/ajax/manage.php?action=orderedit&id=<?php echo $one['id']; ?>" class="ajaxlink">edit</a> | <a href="/ajax/manage.php?action=orderview&id=<?php echo $one['id']; ?>" class="ajaxlink">detail</a> | <a href="/ajax/manage.php?action=orderconfirm&id=<?php echo $one['id']; ?>" class="ajaxlink">confirm</a> | <a href="/ajax/manage.php?action=ordercancel&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="sure to cancel it?">cancel</a><!-- | <a href="/ajax/manage.php?action=orderremove&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="sure to delete this order?">delete</a>--> | <a href="/ajax/manage.php?action=orderhanging&id=<?php echo $one['id']; ?>" class="ajaxlink">Tạm hoãn</a></td>
					</tr>
					<?php }}?>
