...
class ZCard
{
	...
	static public function Explain($errno) {
		switch($errno) {
			case self::ERR_NOCARD : return 'coupon doesnt exist';
			case self::ERR_TEAM : return 'coupon not applicable for this deal';
			case self::ERR_CREDIT : return 'coupon value is restricted';
			case self::ERR_EXPIRE : return 'expired';
			case self::ERR_USED : return 'coupon used';
			case self::ERR_ORDER: return 'one coupon only for one deal';
		}
