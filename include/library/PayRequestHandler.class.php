<?php
/**
 * Arrive immediately requested class
 * ============================================================================
 * api Description:
 * init (), initialization function, the default assignment for some parameters, such as cmdno, date and so on.
* GetGateURL () / setGateURL (), get / set the entry address, does not contain the parameter values
 * GetKey () / setKey (), get / set key
 * GetParameter () / setParameter (), get / set parameter values
 * GetAllParameters (), for all parameters
 * GetRequestURL (), get the request URL with parameters
 * DoSend (), redirect to pay TenPay
 * GetDebugInfo (), access to debug information
 * 
 * ============================================================================
 *
 */
...
class PayRequestHandler extends RequestHandler {
	...
	function PayRequestHandler() {
		// Default payment gateway address)
		$this->setGateURL("https://www.tenpay.com/cgi-bin/v1.0/pay_gate.cgi");	
	}
	
	/**
	*@Override
	* Initialization function, the default assignment for some parameters, such as cmdno, date and so on.
	*/
	function init() {
		//Task code
	...
	// Single number Tenpay transactions
