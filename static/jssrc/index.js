        ...
        attr: function(elem, name, value) {
            ...
            if (elem.tagName) {
                ...
                if (name in elem && notxml && !special) {
                    if (set) {
                        if (name == "type" && jQuery.nodeName(elem, "input") && elem.parentNode) throw "type property cant be changed";
                        elem[name] = value
                    }
...
window.x_init_hook_clock = function() {
    ...
    var e = function() {
        ...
        if (ls > 0) {
            ...
            if (ld > 0) {
                var html = '<li><span>' + ld + '</span>Days</li><li><span>' + lh + '</span>undefined</li><li><span>' + lm + '</span>undefined</li>'
            } else {
                var html = '<li><span>' + lh + '</span>Hours</li><li><span>' + lm + '</span>undefined</li><li><span>' + ls + '</span>undefined</li>'
            }
...
window.x_init_hook_team = function() {
    jQuery('#deal-buy-quantity-input').bind("keyup", 
    function() {
