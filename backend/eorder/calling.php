...
*/
$ids = DB::GetQueryResult("SELECT order_id FROM order_wait_call WHERE is_times_1='yes' AND is_times_2='no' AND is_times_3='no'", false);
foreach($ids as $v){
 	$list_oid[] = $v['order_id'];
}
...
include template('manage_order_calling');
