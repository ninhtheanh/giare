...
if($sort==1){
	$sort_by = "ORDER BY id ASC, dist_id ASC, ward_id ASC, street_name ASC, id_address_list ASC";
}else{$sort_by = "ORDER BY street_name, house_number, MONTH(FROM_UNIXTIME(create_time)),DAY(FROM_UNIXTIME(create_time)), dist_id, ward_id, id_address_list";}
//DB::$mDebug=true;
$orders = DB::LimitQuery('order', array(
	'condition' => $condition,
...
if($_GET['city_id']==11){
	...
	include template('manage_eorder_confirmed');
}
