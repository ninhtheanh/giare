...
if ($pbday) { 
	$pbtime = strtotime($pbday." 00:00:00");
	$condition[] = "delivery_time >= '{$pbtime}'";
}
if ($peday) { 
	$petime = strtotime($peday." 23:59:59");
...
$total_voucher_successful = Table::Count('order', $condition, 'quantity_successful');
...
include template('manage_order_datratien');
